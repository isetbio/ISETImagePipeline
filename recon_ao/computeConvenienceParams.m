...
if (pr.forwardAORender)
    cnv.forwardRenderStructureName = sprintf('%sDisplayRender_%02.f_%d_%0.2f_%0.2f_%d_%s_AO_%0.2f_%s_%s_%d.mat', ...
        pr.displayName,pr.displayScaleFactor,pr.fieldSizeMinutes,pr.eccXDegs,pr.eccYDegs,pr.nPixels,num2str(cnv.forwardPupilDiamMM),pr.forwardDefocusDiopters,cnv.forwardSeedStr, pr.forwardChrom, pr.forwardEccVars);
else
    cnv.forwardRenderStructureName = sprintf('%sDisplayRender__%0.2f_%d_%0.2f_%0.2f_%d_%s_NOAO_%0.2f_%s_%d_%s_%s_%d.mat', ...
        pr.displayName,pr.displayScaleFactor,pr.fieldSizeMinutes,pr.eccXDegs,pr.eccYDegs,pr.nPixels,num2str(cnv.forwardPupilDiamMM),pr.forwardDefocusDiopters,pr.forwardZernikeDataBase,pr.forwardSubjectID, ...
        cnv.forwardSeedStr, pr.forwardChrom, pr.forwardEccVars);
end
if (pr.reconAORender)
    cnv.reconRenderStructureName = sprintf('%sDisplayRender_%0.2f_%d_%0.2f_%0.2f_%d_%s_AO_%0.2f_%s_%s_%d.mat', ...
        pr.displayName,pr.displayScaleFactor,pr.fieldSizeMinutes,pr.eccXDegs,pr.eccYDegs,pr.nPixels,num2str(cnv.reconPupilDiamMM),pr.reconDefocusDiopters, cnv.reconSeedStr, pr.reconChrom, pr.reconEccVars);
else
    cnv.reconRenderStructureName = sprintf('%sDisplayRender_%0.2f_%d_%0.2f_%0.2f_%d_%s_NOAO_%0.2f_%s_%d_%s_%s_%d.mat', ...
        pr.displayName,pr.displayScaleFactor,pr.fieldSizeMinutes,pr.eccXDegs,pr.eccYDegs,pr.nPixels,num2str(cnv.reconPupilDiamMM),pr.reconDefocusDiopters, pr.reconZernikeDataBase,pr.reconSubjectID, ...
