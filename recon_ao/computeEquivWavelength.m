...
if (COMPUTEFORRGB)
    ...
    rgbValues = [0.1268    0.0971    0.0739    0.0536    0.0335    0.0255    0.0184    0.0123    0.0077    0.0040    0.0016    0.0001    0.0001 ;
                 0.0240    0.0270    0.0299    0.0328    0.0365    0.0385    0.0404    0.0426    0.0445    0.0467    0.0489    0.0511    0.0517 ;
