...
specifiedStarts = {};
[multistartStruct] = estimator.runMultistartEstimate(forwardExcitationsToStimulusUse * scaleFactor, ...
    'maxIter', 500, 'display', 'iter', 'gpu', false, ...
    'nWhiteStart', 0, 'nPinkStart', 1, ...
    'nSparsePriorPatchStart', 0, 'sparsePrior', prior, ...
