...
elseif ~(rrf.rerunImages)
    ...
    forwardChromList = ["quadSeq68" "quadSeq69" "quadSeq70" "quadSeq71" "quadSeq72" "quadSeq73" "quadSeq74" "quadSeq75" "quadSeq76"]; % Don't forget to run QS34 on 4@0.5
    reconChromList =   ["quadSeq68" "quadSeq69" "quadSeq70" "quadSeq71" "quadSeq72" "quadSeq73" "quadSeq74" "quadSeq75" "quadSeq76"]; % 36, 38, 40, 42, 44
    ...
    isoLumRG = true;
    colorStepRG = [-1280 -880 -480 0 240 480 720 960 1200 1440 1680];
